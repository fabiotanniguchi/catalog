...
import br.unicamp.sindo.catalog.external.payment.dto.PaymentResultData;
...
public class OrderService {
    ...
    public OrderEntity save(WebsitePaymentData data, PaymentResultData payment, String logisticsId) {
